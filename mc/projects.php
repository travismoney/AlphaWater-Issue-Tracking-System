...
<html lang="en">
    <head>
        ...
        <title>AlphaWater - Projects</title>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                                <a class="btn btn-success my-2" href="add_project" role="button">Add New Project</a>
                                    ...
                                    <form class="form-inline my-2 my-lg-0">
                                        <input type="text" name="search_text" id="search_text" class="form-control mr-sm-2" placeholder="Search">
                                    </form>
                                </div>
                            </nav>
                        <div class="limiter">
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted" style="margin: 0px auto;">AlphaWater - UNIMAS SUSTAINABLE WATER TREATMENT SYSTEM</div>
                        </div>
                    </div>
                </footer>
            </div>
