                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                            <h5 class="font-weight-light">Registered Users</h5>
                                    ...
                                    <form class="form-inline my-2 my-lg-0">
                                        <input type="text" name="search_text" id="search_text" class="form-control mr-sm-2 my-2" placeholder="Search">
                                    </form>
                                </div>
                            </nav>
                            <div class="limiter">
