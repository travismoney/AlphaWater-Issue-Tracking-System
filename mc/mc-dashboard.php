...
$get_users = "select * from users where user_id != '100'";
    
$run_users = mysqli_query($con,$get_users);

$count_users = mysqli_num_rows($run_users);

// Chart Counting Section

// Pending Issues - Main Contractor

$pending_issues_counter = 0;

$total_pending_issues = "select * from issues where current_progress = '1' ";
...
// In Progress Issues - Main Contractor

$inprogress_issues_counter = 0;

$total_inprogress_issues = "select * from issues where current_progress = '2' ";
...
// Completed Issues - Main Contractor

$completed_issues_counter = 0;

$total_completed_issues = "select * from issues where current_progress = '3' ";
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-4 col-md-6 ">
                                ...
                                <div class="card-body" style="font-size: 25px;">
                                    Projects <span class="float-right"><?php echo $count_projects; ?></span>
                                </div>
                            ...
                            <div class="col-xl-4 col-md-6">
                                ...
                                <div class="card-body" style="font-size: 25px;">
                                    Issues <span class="float-right"><?php echo $count_issues; ?></span>
                                </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between" style="padding-bottom: 10px !important; border-top: 1px solid rgba(0, 0, 0, 0.125) !important;">
                            ...
                            <div class="col-xl-4 col-md-12">
                                ...
                                <div class="card-body" style="font-size: 25px;">
                                    Users <span class="float-right"><?php echo $count_users; ?></span>
                                </div>
                                    <div class="card-footer d-flex align-items-center justify-content-between" style="padding-bottom: 10px !important; border-top: 1px solid rgba(0, 0, 0, 0.125) !important;">
                        ...
                        <div class="card mb-4 shadow-lg">
                            <div class="card-header"><h4>Recent Issues</h4></div>
                            <div class="card-body">
                            <div class="limiter">
					                ...
					                <table>
						                ...
						                <tbody>
                                            <?php
                                                ...
                                                $get_issues = "select * from issues ORDER BY 1 DESC";
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 right">
                                                    ...
                                                    <?php
                                                        ...
                                                        $get_recent_updates = "select * from recent_updates where user_id != '$user_id' ORDER BY 1 DESC";
