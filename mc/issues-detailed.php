                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card-header">
                            <div class="row ml-0 pt-3" style="display: flex !important; background-color: rgba(0, 0, 0, 0.001);">
                                ...
                                <div class="col-sm-4">
                                    <button onclick="location.href='delete_issue?delete_issue=<?php echo $issue_id; ?>'"type="button" class="btn btn-danger float-right ml-2">Delete Issue</button>
                                    <button onclick="location.href='edit_issue?edit_issue=<?php echo $issue_id; ?>'" type="button" class="btn btn-primary float-right">Edit Issue</button>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="chat-message section-message-scroll">
                                            ...
                                            <?php
                                                ...
                                                while($row_comments=mysqli_fetch_array($run_comments)){
                                                    ...
                                                    $comment_time = new DateTime($row_comments["comment_time"]);

                                                    $comment_time_formatted = date_format($comment_time, "d F Y - h:i A");
                                                ...
                                                <li class="left clearfix">
                    	                            <div class="chat-body clearfix">
                    		                            <div class="header">
                    			                            ...
                    			                            <small class="pull-right text-muted">(<?php echo $comment_time_formatted; ?>)</small>
                    		                            </div>
                    		                            <p>
                    			                        <?php echo $comments; ?>
                    		                             </p>
