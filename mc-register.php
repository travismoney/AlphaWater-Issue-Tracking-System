                            ...
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg my-5">
                                    <div class="card-header">
                                        <h3 class="text-center font-weight-light mt-4">Register New Account</h3>
                                        <h5 class="text-center font-weight-light mt-3">Main Contractor</h5>
                                    </div>
                                    <div class="card-body">
                                        <form action="" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="role" class="form-control py-4" id="inputRole" type="text" value="Main Contractor" required readonly>
                                            </div>
                                            <!-- Register Button -->
