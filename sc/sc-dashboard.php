...
// counting total number of issues - sub contractor

$get_issues = "select * from issues where assignee = '$user_id'";
...
$total_pending_issues = "select * from issues WHERE assignee = '$user_id' AND current_progress = '1' ";
...
$total_inprogress_issues = "select * from issues WHERE assignee = '$user_id' AND current_progress = '2' ";
...
$total_completed_issues = "select * from issues WHERE assignee = '$user_id' AND current_progress = '3' ";
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-md-12">
                                ...
                                <div class="card-body" style="font-size: 25px;">
                                    Issues Received <span class="float-right"><?php echo $count_issues; ?></span>
                                </div>
					                ...
					                <table>
						                ...
						                <tbody>
                                            <?php
                                                ...
                                                $get_issues = "select * from issues where assignee = '$user_id' ORDER BY 1 DESC";
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12 right">
                                                    ...
                                                    <?php
                                                        ...
                                                        $get_recent_updates = "select * from recent_updates where assignee_id = '$user_id' and user_id != '$user_id' and update_information != 'added a new Issue #' ORDER BY 1 DESC";
